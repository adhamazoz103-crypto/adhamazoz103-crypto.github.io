...
exports.heroContent = {
    ...
    subheading: 'حلول قانونية احترافية لحماية حقوق الأفراد والشركات.',
    description: 'في عالم تتزايد فيه التحديات القانونية، لا يكفي أن يكون لديك محامٍ، بل تحتاج إلى شريك قانوني يمتلك الخبرة والرؤية والاستراتيجية. نساعد عملاءنا على اتخاذ القرارات القانونية الصحيحة، ونمثلهم بكفاءة في مختلف أنواع القضايا، مع الالتزام بالسرية والشفافية والاحترافية.',
    buttons: [
        {
            label: 'احجز استشارة',
            href: '#contact',
